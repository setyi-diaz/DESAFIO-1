...
void rota1PiezaT(){
    ...
    // Ingresa 1s
    Tablero[(ultFilaPieza - 2)][((priColPieza + 1) / 8)] |= mascara;
    // Ingresa 0s
...
void rota3PiezaT(){
    ...
    if(((Tablero[(ultFilaPieza - 1)][(priColPieza / 8)] & mascara) == 0x00) &&
        ((Tablero[(ultFilaPieza - 2)][(priColPieza / 8)] & mascara) == 0x00)){
        // Ingresa 1s
        Tablero[(ultFilaPieza - 1)][(priColPieza / 8)] |= mascara;
        Tablero[(ultFilaPieza - 2)][(priColPieza / 8)] |= mascara;
        // Ingresa 0s
...
void bajarPiezaTOrigin(const int &y){
    ...
    char validar = valBajarPiezaTOrigin();
...
void desplazarIzqTRot1(){
    ...
    if(priColPieza == 0){
        ...
        ((Tablero[(ultFilaPieza - 1)][((priColPieza - 1) / 8)] & mascara2) == 0x00) &&
        ((Tablero[(ultFilaPieza - 2)][(priColPieza / 8)] & mascara1)== 0x00)){
        // Ingresa 1s
        Tablero[(ultFilaPieza)][(priColPieza / 8)] |= mascara1;
        Tablero[(ultFilaPieza - 1)][((priColPieza - 1) / 8)] |= mascara2;
        Tablero[(ultFilaPieza - 2)][(priColPieza / 8)] |= mascara1;
...
void desplazarIzqTRot3(){
    ...
    if(priColPieza == 0){
        ...
        ((Tablero[(ultFilaPieza - 2)][((priColPieza - 1) / 8)] & mascara1)== 0x00)){
        // Ingresa 1s
        Tablero[(ultFilaPieza)][((priColPieza - 1) / 8)] |= mascara1;
        Tablero[(ultFilaPieza - 1)][((priColPieza - 1) / 8)] |= mascara1;
        Tablero[(ultFilaPieza - 2)][((priColPieza - 1) / 8)] |= mascara1;
...
void desplazarDerTOrigin(const int &x){
    ...
    if((priColPieza + 3) == x*8){
        ...
        // Ingresa 1s
        Tablero[(ultFilaPieza)][((priColPieza + 2) / 8)] |= mascara1;
        Tablero[(ultFilaPieza - 1)][((priColPieza + 3) / 8)] |= mascara2;
        // Ingresa 0s
        mascara1 = (0x80 >> ((priColPieza + 1) % 8));
        Tablero[(ultFilaPieza)][((priColPieza + 1) / 8)] ^= mascara1;
...
void desplazarDerTRot1(const int &x){
    ...
    if((priColPieza + 2) == x*8){
        ...
        ((Tablero[(ultFilaPieza - 2)][((priColPieza + 2) / 8)] & mascara1)== 0x00)){
        // Ingresa 1s
        Tablero[(ultFilaPieza)][((priColPieza + 2) / 8)] |= mascara1;
